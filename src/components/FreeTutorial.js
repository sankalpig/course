...
export default function FreeTutorial() {
    return (
        <div className=''  >
            <div className='container ' id='free' style={{ marginTop: "9rem" }}>
                <div className='row  '>
                    <div className='col-7 card-background'>
                        <div className='d-flex '>
                            <div class="card cutom-card position-relative" style={{ width: "19rem", margin: -"5rem 6rem" }}>
                            ...
                            <div class="card cutom-card position-absolute" style={{ width: "19rem", margin: "-3rem 7rem" }}>
                                <img src={img} class="card-img-top custom-card-img" alt="..." />
                                <div class="card-body">
                                    <div className='d-flex gap-1'>
                                        <span > <FontAwesomeIcon className='py-2 cstar' icon={solidStar} /></span>
                    ...
                    <div className='col-5' style={{ marginTop: "-4rem", padding: "0rem 3rem" }}>
                        <span className='header-text'>Free tutorial</span>
                        <h4 className='py-3 core-subtext'>More than thousand of free tutorial upload every weeks</h4>
