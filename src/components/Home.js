...
import img1 from '../images/back1.jpeg'
...
export default function Home() {
    return (
        <>
            ...
            <div className='d-flex   flex-nowrap' id='home'>
                ...
                <div className='d-flex justify-content-end' style={{ marginLeft: "-24rem", marginTop: "6rem" }} >
